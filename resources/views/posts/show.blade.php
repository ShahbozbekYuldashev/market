    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="row mb-4">
                        <a class="btn btn-sm btn-outline-secondary mr-2" href="{{ route('blog.edit', ['blog' => $blog->id]) }}">O'zgartirish</a>
                    ...
                    <div class="mb-5">
                        <img class="img-fluid rounded w-100 mb-4" src="{{ asset('storage/'. $blog->photo) }}" alt="Image">
                        <p>{{ $blog->body }}</p>

                    </div>

                    <div class="mb-5">
                        <h3 class="mb-4 section-title">Izohlar ({{ $blog->comments()->count() }})</h3>
